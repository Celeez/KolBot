var AutoMule = {
	Mules: {
		"Mule1":  {
			muleProfile: "Prymule",  // The name of mule profile in d2bot#. It will be started and stopped when needed.
			accountPrefix: "Prymule",  // Account prefix. Numbers added automatically when making accounts.
			accountPassword: "iownedu123",  // Account password.
			charPrefix: "Prymals",  // Character prefix. Suffix added automatically when making characters.
			...
			muleGameName: ["PrymLewt", "qq"], // ["gamename", "password"]

			// List of profiles that will mule items. Example: enabledProfiles: ["profile 1", "profile 2"],
			enabledProfiles: ["ISOHrs", "ISOUniques", "ISOCharms", "ISOExperience"],
