...
function LoadConfig() {
	...
	*/
	...
	// Potion settings
	Config.UseHP = 92; // Drink a healing potion if life is under designated percent.
	...
	// Chicken settings
	Config.LifeChicken = 50; // Exit game if life is less or equal to designated percent.
	...
	Config.Runewords.push([Runeword.Insight, "Scythe"]); // Make Insight Scythe
	Config.Runewords.push([Runeword.Insight, "Poleaxe"]); // Make Insight Poleaxe
	Config.Runewords.push([Runeword.Insight, "Partizan"]); // Make Insight Partizan
	...
	Config.KeepRunewords.push("[type] == sword || [type] == weapon # [fcr] == 35");
	...
	Config.CastStatic = 30; // Cast static until the target is at designated life percent. 100 = disabled.
	Config.StaticList = [ "Andariel" , "Griswold" , "The Smith" , "The Countess" , "Diablo" , "Mephisto" , "Baal" ]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
