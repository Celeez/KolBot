...
function LoadConfig() {
	...
	*/
	...
	Config.StaticList = ["Andariel", "Griswold", "The Smith", "The Countess"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
