...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["ISOCharms"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Scripts.ClearAnyArea = false; // Clear any area. Uses Config.ClearType to determine which type of monsters to kill.
		Config.ClearAnyArea.AreaList = [3, 4, 5, 6, 7, 21, 22, 23 , 24]; // List of area ids to clear. See sdk/areas.txt
	...
	Config.HealMP = 15; // Go to a healer if under designated percent of mana.
	Config.HealStatus = false; // Go to a healer if poisoned or cursed
	Config.UseMerc = true; // Use merc. This is ignored and always false in d2classic.
	Config.MercWatch = false; // Instant merc revive during battle.

	// Potion settings
	Config.UseHP = 95; // Drink a healing potion if life is under designated percent.
	Config.UseRejuvHP = 80;  // Drink a rejuvenation potion if life is under designated percent.
	Config.UseMP = 80; // Drink a mana potion if mana is under designated percent.
	Config.UseRejuvMP = 10; // Drink a rejuvenation potion if mana is under designated percent.
	Config.UseMercHP = 65; // Give a healing potion to your merc if his/her life is under designated percent.
	...
	// Chicken settings
	Config.LifeChicken = 77; // Exit game if life is less or equal to designated percent.
	...
	Config.PickitFiles.push("Uniques.nip");
	Config.PickitFiles.push("Charms.nip");
	Config.PickitFiles.push("Misc.nip");
	Config.PickitFiles.push("Base.nip");
	...
	Config.ItemInfoQuality = [6]; // The quality of sold items to log. See NTItemAlias.dbl for values. Example: Config.ItemInfoQuality = [6, 7, 8];

	// Item identification settings
	Config.CainID.Enable = false; // Identify items at Cain
	Config.CainID.MinGold = 5; // Minimum gold (stash + character) to have in order to use Cain.
	...
	Config.PingQuit = [{Ping: 2000, Duration: 5}]; // Quit if ping is over the given value for over the given time period in seconds.

	// Shrine Scanner - scan for shrines while moving.
	// Put the shrine types in order of priority (from highest to lowest). For a list of types, see sdk/shrines.txt
	Config.ScanShrines = [ 15, 13, 8, 9, 10, 13];
	...
	Config.SkipImmune = [ "cold and physical", "cold"];
	...
	Config.StaticList = ["Andariel", "Griswold", "The Smith", "The Countess", "Blood Raven", "Mephisto"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
