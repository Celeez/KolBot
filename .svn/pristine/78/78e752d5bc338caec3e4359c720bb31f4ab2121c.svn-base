...
function LoadConfig() {
	...
	Scripts.BattleOrders = true;
		...
		Config.BattleOrders.Getters = ["ISOHrs", "ISOCharms"]; // List of players to wait for before casting Battle Orders (mode 0). All players must be in the same area as the BOer.
	...
	*/
	...
	Config.QuitList = ["ISOHrs"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
