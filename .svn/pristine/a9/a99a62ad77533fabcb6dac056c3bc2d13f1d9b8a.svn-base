...
function LoadConfig() {
	...
	*/
	...
	Config.UseRejuvHP = 85;  // Drink a rejuvenation potion if life is under designated percent.
	...
	Config.UseMercHP = 10; // Give a healing potion to your merc if his/her life is under designated percent.
